...
import com.cashbook.cashbook.adapter.WheelAdapter;
import com.cashbook.cashbook.handler.MessageHandler;
import com.cashbook.cashbook.interfaces.IPickerViewData;
import com.cashbook.cashbook.listener.LoopViewGestureListener;
import com.cashbook.cashbook.listener.OnItemSelectedListener;
import com.cashbook.cashbook.task.InertiaTimerTask;
import com.cashbook.cashbook.task.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.pickerview_topbar_padding);//默认大小
